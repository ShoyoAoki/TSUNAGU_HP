        ...
        <section className="max-w-4xl mx-auto px-6 py-40">
          ...
          >
            ...
            <div className="space-y-8 text-lg md:text-xl leading-[2.2] text-gray-700 font-light tracking-wide">
              ...
              <p>
                セネカが二千年も前に説いたこの真理は、現代のビジネスにおいても何ら変わりません。私たちは、自分たちが持っている時間を浪費している。あるいは、非効率なシステムの犠牲になっている。
              </p>
              <p>
                TSUNAGUがなぜ存在するのか。それは、テクノロジーの力で世界中の『意志』を最短距離でつなぎ、人類が本来持っているはずの時間を、より価値ある創造へと解放するためです。
              </p>
              <p>
          ...
          <div className="space-y-40">
            ...
            >
              ...
              <div className="space-y-8 text-lg md:text-xl text-gray-700 font-light tracking-wide leading-[2.2]">
                ...
                <p>
                  TSUNAGUは、この名と象徴（∞）を胸に、世界中のポテンシャルが正しく繋がる未来を、今、この瞬間に実装していきます。
                </p>
              </div>
