...
/**
 * 「アクセスできる人材」3D回転カルーセル（ヒーロー直下）— zh版
 * ja版（src/app/service/AccessibleTalent.tsx）と構造・スタイルは完全に同一。文字列のみ簡体字中国語に差し替え。
 */
...
const TALENTS: Talent[] = [
  { label: "LANGUAGE", name: "语言人才", img: "/images/talent/language.jpg", Glyph: MessagesSquare, accent: "#e8930c",
    lead: "N2以上，中日双语人才。", tags: ["日语 N2 以上", "商社・制造业・服务业", "零前期费用・成功报酬制"], service: "OwlMatch Language" },
  { label: "ROBOTICS / AI / IT", name: "机器人・AI・IT人才", img: "/images/talent/tech.jpg", gear: true, spin: true, accent: "#06b6d4",
    lead: "来自中国的机器人・AI・IT人才。", tags: ["OwlMatch 认证筛选", "机器人・AI・IT", "先远程试用再录用"], service: "OwlMatch Remote" },
  { label: "CROSS-BORDER", name: "短期项目人才", img: "/images/talent/spot.jpg", Glyph: MapPin, accent: "#6366f1",
    lead: "以天为单位灵活调配的当地人才。", tags: ["中国当地短期项目", "以天为单位验证实力", "跨境合规对接（PIPL）"], service: "OwlMatch Spot" },
];
    ...
    <section className="relative overflow-hidden bg-[#FAFAF7] pt-40 pb-28 md:pt-36 md:pb-36 px-6" aria-labelledby="talent-heading">
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <h2 id="talent-heading" className="text-[38px] md:text-[58px] font-medium tracking-[-0.03em] text-slate-900 leading-[1.08]">
          能触达什么样的<br className="hidden md:block" />人才？
        </h2>
        <p className="mt-5 max-w-2xl text-slate-400 text-[15px] leading-[1.75] tracking-[0.01em]">
          OwlMatch 是通往中日跨境三大人才库的入口——语言、机器人・AI・IT、短期项目。
        </p>
        ...
        <div className="mt-16 md:mt-20 relative" style={{ perspective: "2000px" }}>
          ...
          <button type="button" onClick={() => rotate(-1)} aria-label="上一个人才"
          ...
          <button type="button" onClick={() => rotate(1)} aria-label="下一个人才"
        ...
        <div className="mt-5 flex justify-center gap-2.5">
          {TALENTS.map((t, i) => (
            <button key={i} type="button" onClick={() => setActive(i)} aria-label={`切换到${t.name}`}
