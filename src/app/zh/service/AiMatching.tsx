...
/**
 * 「AI マッチング」セクション — zh版
 * ja版（src/app/service/AiMatching.tsx）と構造・スタイルは完全に同一。文字列のみ簡体字中国語に差し替え。
 */
...
const POOL: Person[] = [
  { id: 1, initials: "W.L", name: "W. Liu", role: "AI工程师", tags: ["Python", "LLM"], lang: "日语 N2", loc: "北京・可来日" },
  { id: 2, initials: "K.T", name: "K. Tanaka", role: "中日双语商务拓展", tags: ["销售", "HSK6"], lang: "中文 母语级", loc: "东京" },
  { id: 3, initials: "Y.C", name: "Y. Chen", role: "ML工程师", tags: ["PyTorch", "RAG"], lang: "日语 N2", loc: "深圳・可来日", score: 96 },
  { id: 4, initials: "S.S", name: "S. Sato", role: "全栈工程师", tags: ["React", "Go"], lang: "中文 HSK5", loc: "大阪" },
  { id: 5, initials: "R.W", name: "R. Wang", role: "后端工程师", tags: ["Java", "K8s"], lang: "日语 N1", loc: "上海・远程" },
  { id: 6, initials: "A.I", name: "A. Ito", role: "数据科学家", tags: ["SQL", "BI"], lang: "中文 N/A", loc: "东京" },
  { id: 7, initials: "J.Z", name: "J. Zhao", role: "前端工程师", tags: ["TS", "Next"], lang: "日语 N3", loc: "广州・远程" },
  { id: 8, initials: "H.S", name: "H. Sun", role: "AI工程师", tags: ["LLM", "AWS"], lang: "日语 N2", loc: "杭州・可来日" },
  { id: 9, initials: "M.S", name: "M. Suzuki", role: "产品经理", tags: ["Scrum", "中文"], lang: "中文 母语级", loc: "东京" },
  { id: 10, initials: "L.X", name: "L. Xu", role: "ML工程师", tags: ["PyTorch", "CV"], lang: "日语 N2", loc: "北京・可来日", score: 94 },
  { id: 11, initials: "T.N", name: "T. Nakamura", role: "基础设施工程师", tags: ["K8s", "Terraform"], lang: "中文 HSK4", loc: "远程" },
  { id: 12, initials: "F.G", name: "F. Guo", role: "全栈工程师", tags: ["Vue", "Node"], lang: "日语 N1", loc: "成都・远程" },
  { id: 13, initials: "N.K", name: "N. Kobayashi", role: "口译・笔译", tags: ["中日", "技术"], lang: "中文 母语级", loc: "东京" },
  { id: 14, initials: "Q.L", name: "Q. Lin", role: "AI工程师", tags: ["LLM", "RAG"], lang: "日语 N1", loc: "深圳・可来日", score: 92 },
  { id: 15, initials: "Y.W", name: "Y. Watanabe", role: "后端工程师", tags: ["Go", "gRPC"], lang: "中文 HSK5", loc: "名古屋" },
  { id: 16, initials: "B.H", name: "B. Huang", role: "数据工程师", tags: ["Spark", "ETL"], lang: "日语 N2", loc: "上海・远程" },
  { id: 17, initials: "H.Y", name: "H. Yamamoto", role: "前端工程师", tags: ["React", "UI"], lang: "中文 HSK4", loc: "东京" },
  { id: 18, initials: "D.Z", name: "D. Zhou", role: "ML工程师", tags: ["NLP", "PyTorch"], lang: "日语 N2", loc: "北京・远程" },
  { id: 19, initials: "X.W", name: "X. Wu", role: "全栈工程师", tags: ["TS", "AWS"], lang: "日语 N2", loc: "广州・可来日", score: 90 },
  { id: 20, initials: "R.I", name: "R. Ishida", role: "产品经理", tags: ["PdM", "中文"], lang: "中文 母语级", loc: "东京" },
  { id: 21, initials: "C.Y", name: "C. Yang", role: "AI工程师", tags: ["LLM", "Triton"], lang: "日语 N3", loc: "杭州・远程" },
  { id: 22, initials: "K.M", name: "K. Mori", role: "后端工程师", tags: ["Rust", "DB"], lang: "中文 HSK5", loc: "福冈" },
  { id: 23, initials: "P.S", name: "P. Sun", role: "数据科学家", tags: ["ML", "A/B"], lang: "日语 N2", loc: "上海・可来日" },
  { id: 24, initials: "T.A", name: "T. Aoki", role: "前端工程师", tags: ["Next", "三维"], lang: "中文 HSK4", loc: "东京" },
];
...
const REQ = {
  role: "AI工程师（LLM）",
  must: ["Python / LLM", "日语 N2 以上", "远程→可来日"],
};
    ...
    <section className="relative overflow-hidden bg-[#FAFAF7] pt-40 pb-28 md:pt-36 md:pb-36 px-6" aria-labelledby="match-heading">
      ...
      <div className="container relative z-10 mx-auto max-w-7xl">
        ...
        <p className="mt-5 max-w-2xl text-slate-500 text-[15px] leading-[1.75] tracking-[0.01em]">
          OwlMatch 认证筛选系统扫描中日人才库，为您呈现最契合职位要求的人才。
        </p>
          ...
          <div ref={reqRef} className="relative z-20 mx-auto mb-8 max-w-md rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_8px_30px_-16px_rgba(15,23,42,0.18)]">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <span className="ml-auto font-mono text-[10px] tracking-[0.12em] text-cyan-600 tabular-nums">
                {phase === "match" ? `${MATCHED.length} 个匹配` : "扫描中…"}
              </span>
            </div>
