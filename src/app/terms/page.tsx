    ...
    <main className="min-h-screen bg-white text-gray-900 pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-cyan-600">
          ...
          <h3>第4条（知的財産権）</h3>
          <p>
            当社ウェブサイト及びサービスに関する知的財産権は、当社又は正当な権利者に帰属します。
          </p>

          <h3>第5条（サービスの変更・中断）</h3>
          <p>
            当社は、事前の通知なくサービスの内容を変更し、又はサービスの提供を中断若しくは終了することができるものとします。
          </p>

          <h3>第6条（準拠法・管轄）</h3>
          <p>
            本規約の解釈にあたっては日本法を準拠法とします。本規約に関して紛争が生じた場合には、鹿児島地方裁判所を第一審の専属的合意管轄裁判所とします。
          </p>
