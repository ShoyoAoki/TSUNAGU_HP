...
const processes = [
  {
    id: "01",
    title: "候補者の発見",
    desc: "独自の候補者DBと動画レジュメによる人柄の可視化。履歴書だけでは分からない「熱量」と「コミュニケーション能力」を事前に確認できます。",
  },
  {
    id: "02",
    title: "価値観の測定",
    desc: "独自の価値観スコアリングにより、企業のカルチャーと候補者の志向性のマッチ度を測定。早期離職のリスクを最小化します。",
  },
  {
    id: "03",
    title: "最速の採用決定",
    desc: "スピード感のあるダイレクトスカウトと自動面接設定。煩雑な調整を排除し、最短距離で採用決定まで導きます。",
  },
];
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="max-w-2xl text-lg md:text-xl text-gray-600 leading-relaxed">
                ...
                特定技能・高度人材の「採用」に特化した最適化プラットフォーム。
              </p>
            </motion.div>
          </div>
        </section>
